...
const reportsFolderPath = path.join(__dirname, `../../Reports_Pos_dinein_2`);
...
const collectionPath = path.join(
  __dirname,
  "../collection_variables/api_collection/e2e_pos_dine_qa.json"
);
const environmentPath = path.join(
  __dirname,
  "../collection_variables/api_collection/qa_env_e2e.json"
);
